...
DATASET_ROOT_few = dataset_root + set_num +  "balanced3"
...
DATASET_CATEGORIES = [
    ...
    #{"name": "flushworm", "id": 4, "isthing": 1, "color": [220, 20, 60]},
    #{"name": "formosa", "id": 6, "isthing": 1, "color": [219, 142, 185]},
    {"name": "fungi_early", "id": 4, "isthing": 1, "color": [220, 20, 60]},
    #{"name": "miner", "id": 6, "isthing": 1, "color": [219, 142, 185]},
    {"name": "mosquito_early", "id": 5, "isthing": 1, "color": [220, 20, 60]},
    {"name": "mosquito_late", "id": 6, "isthing": 1, "color": [219, 142, 185]},
    {"name": "moth", "id": 7, "isthing": 1, "color": [220, 20, 60]},
    #{"name": "other", "id": 12, "isthing": 1, "color": [219, 142, 185]},
    {"name": "roller", "id": 8, "isthing": 1, "color": [220, 20, 60]},
    #{"name": "tetrany", "id": 14, "isthing": 1, "color": [219, 142, 185]},
    #{"name": "thrips", "id": 11, "isthing": 1, "color": [220, 20, 60]},
    {"name": "tortrix", "id": 9, "isthing": 1, "color": [219, 142, 185]},
]
...
def setup(args):
    ...
    ITERS_IN_ONE_EPOCH = int(48 / cfg.SOLVER.IMS_PER_BATCH)
    ...
    cfg.OUTPUT_DIR = "checkpoints/coco/faster_rcnn/" + set_num + split_num + "3shot_2stage"
