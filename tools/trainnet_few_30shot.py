...
DATASET_ROOT_few = dataset_root + set_num + split_num + "few_30"
...
def setup(args):
    ...
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = 17  #need change
    ...
    ITERS_IN_ONE_EPOCH = int(120 / cfg.SOLVER.IMS_PER_BATCH) #need change
    ...
    cfg.TEST.EVAL_PERIOD = (ITERS_IN_ONE_EPOCH * 24) - 1 # evaluation at final only
    cfg.OUTPUT_DIR = "checkpoints/coco/faster_rcnn/" + set_num + split_num + "few_30"
