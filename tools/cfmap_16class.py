...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        return COCOEvaluator_eric(dataset_name, cfg, distributed=False, output_dir=output_folder)# cfmap COCOEvaluator_eric
...
def setup(args):
    ...
    ITERS_IN_ONE_EPOCH = int(3776 / cfg.SOLVER.IMS_PER_BATCH) #need change
    ...
    cfg.OUTPUT_DIR = "checkpoints/coco/faster_rcnn/eval" #need change
