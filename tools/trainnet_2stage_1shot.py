...
DATASET_ROOT_few = dataset_root + set_num +  "balanced1"
...
def setup(args):
    ...
    ITERS_IN_ONE_EPOCH = int(16 / cfg.SOLVER.IMS_PER_BATCH)
    ...
    cfg.OUTPUT_DIR = "checkpoints/coco/faster_rcnn/" + set_num + split_num + "1shot_2stage"
