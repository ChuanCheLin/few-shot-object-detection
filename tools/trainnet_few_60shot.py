...
DATASET_ROOT_few = dataset_root + set_num + split_num + "few_60"
...
def setup(args):
    ...
    ITERS_IN_ONE_EPOCH = int(240 / cfg.SOLVER.IMS_PER_BATCH) #need change
    ...
    cfg.OUTPUT_DIR = "checkpoints/coco/faster_rcnn/" + set_num + split_num + "few_60"
