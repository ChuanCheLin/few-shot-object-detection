...
def setup(args):
    ...
    cfg.MODEL.WEIGHTS = "checkpoints/coco/faster_rcnn/" + set_num + split_num + "few_30/combined/model_reset_combine.pth"
    cfg.OUTPUT_DIR = "checkpoints/coco/faster_rcnn/" + set_num + split_num + "30shot_3stage"
